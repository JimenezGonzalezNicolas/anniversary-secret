...
export default function Cards() {
    return (
        <div className="w-full lg:flex justify-center my-3 px-10">
            <div className="w-full lg:w-60 bg-white border border-gray-200 rounded-lg shadow my-3 lg:mx-3 cursor-pointer">
                <img className="rounded-t-lg h-80 w-full object-cover grayscale hover:grayscale-0" src={first} alt="" />
            ...
            <div className="w-full lg:w-60 bg-white border border-gray-200 rounded-lg shadow my-3 lg:mx-3 cursor-pointer">
                <img className="rounded-t-lg h-80 w-full object-cover grayscale hover:grayscale-0" src={second} alt="" />
                <div className="p-5 text-center">
            ...
            <div className="w-full lg:w-60 bg-white border border-gray-200 rounded-lg shadow my-3 lg:mx-3 cursor-pointer">
                <img className="rounded-t-lg h-80 w-full object-cover grayscale hover:grayscale-0" src={third} alt="" />
                <div className="p-5 text-center">
